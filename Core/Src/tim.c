...
void MX_TIM6_Init(void)
{
  ...
  /* TIM6 is now a pure hardware pacer: its update event drives TRGO, which
   * triggers ADC1 directly. The control loop runs from the ADC's
   * end-of-conversion interrupt, so TIM6 needs no interrupt of its own. */
...
void HAL_TIM_OC_MspInit(TIM_HandleTypeDef* tim_ocHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA6     ------> TIM1_BKIN
    */
    GPIO_InitStruct.Pin = M_BKIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_TIM1;
    HAL_GPIO_Init(M_BKIN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = M_PWM_AN_Pin|M_PWM_A_Pin|M_PWM_B_Pin;
    ...
    GPIO_InitStruct.Pin = M_PWM_BN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_TIM1;
    HAL_GPIO_Init(M_PWM_BN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_OC_MspDeInit(TIM_HandleTypeDef* tim_ocHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOA, M_BKIN_Pin|M_PWM_AN_Pin|M_PWM_A_Pin|M_PWM_B_Pin);

    HAL_GPIO_DeInit(M_PWM_BN_GPIO_Port, M_PWM_BN_Pin);
